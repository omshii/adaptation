% Reads a matrix of ffs parameter values
...
param_sets = readmatrix('ffs_param_manual.csv');
...
writematrix(susceptibility, "ffs_susceptibility_1i_25n.csv");
writematrix(noise_amplification, "ffs_noise_1i_25n.csv");