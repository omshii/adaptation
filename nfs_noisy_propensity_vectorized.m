...
reaction_rates = [params.k1*I.*(params.A0-reactants(:, 1)), (params.k2*reactants(:, 1).*reactants(:, 2))/params.B0, (params.k3*reactants(:, 1).*(params.B0-reactants(:, 2)))./(params.A0*(params.K3+1-(reactants(:, 2)/params.B0))), (params.k4*reactants(:, 2)*params.B0)./(params.K4*params.B0+reactants(:, 2))];
